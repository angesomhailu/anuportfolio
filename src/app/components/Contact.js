        ...
        >
            <div className="mx-auto max-w-6xl">
                ...
                <div className="grid gap-10 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div className="mt-8 space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-50 text-xl text-blue-600">
                                    <FiMapPin />
                                </div>
                    ...
                    {/* Contact form */}
                    <form
                        className="rounded-2xl border border-gray-200 bg-gray-50 p-7 shadow-sm md:p-8"
                    >
                        <div className="grid gap-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full resize-none rounded-lg border border-gray-300 bg-white px-4 py-3 outline-none transition focus:border-blue-600 focus:ring-2 focus:ring-blue-100"
                                />
                            </div>
